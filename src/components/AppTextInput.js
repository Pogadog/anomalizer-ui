                ...
                return (
                    <View>
                        <TextInput 
                            ...
                            style={{...style.main, fontSize: this.props.disableAutoFontSize ? this.props.disableAutoFontSize :  this.state.fontSize >= this.props.fontSizeAutoAdjust?.min ? this.state.fontSize : this.props.fontSizeAutoAdjust?.min || this.defaultFontSize, ...this.props.style, color: darkMode.enabled ? "white" : 'black', borderWidth: 1, borderColor: ThemeValues.colors.palette.primary, paddingRight: this.props.action ? 40 : 0}}
